...
--
-- Table structure for table `nivelprograma`
--

DROP TABLE IF EXISTS `nivelprograma`;
...
--
-- Dumping data for table `nivelprograma`
--

LOCK TABLES `nivelprograma` WRITE;
/*!40000 ALTER TABLE `nivelprograma` DISABLE KEYS */;
INSERT INTO `nivelprograma` VALUES (1,'Licenciatura'),(2,'Posgrado');
/*!40000 ALTER TABLE `nivelprograma` ENABLE KEYS */;
UNLOCK TABLES;
