...
<html lang="en">
        <p></p>
        <h2 class="bg-warning p-1 text-white" align="center">Modificar Registro</h2>
        <p></p>
        <div align="center">
                ...
                <div class="container mt-5" align="center">
                  ...
                  <tr>
                   ...
                   <tr>
                    ...
                    <td><select class="form-select form-select-lg mb-3" name="NivelPrograma" id="nivelprograma">
                        ...
                        <option value="<?php echo $row['programa_nivelprograma_idNivelPrograma']  ?>"> Licenciatura </option>
                  ...
                  <tr> 
                        ...
                        <select class="form-select form-select-lg mb-3" name="Programa" id="programa" required>
                             <option value="<?php echo $row['programa_idPrograma']  ?>"> <?php if ($row['programa_idPrograma']==1){ echo "LC"; } 
